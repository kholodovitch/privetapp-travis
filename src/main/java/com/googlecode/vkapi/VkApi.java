...
public interface VkApi {
    ...
    Collection<VkGroup> getGroups(OAuthToken authToken, int count) throws VkException;
    ...
    Collection<VkPhoto> currentUserProfilePhotos(OAuthToken authToken) throws VkException;

	Collection<VkAlbum> albums(OAuthToken authToken) throws VkException;

	Collection<VkPhoto> get(OAuthToken authToken, long albumId) throws VkException;

	Collection<VkPhoto> photosGetById(OAuthToken authToken, long[] photoIds) throws VkException;

	Collection<VkPhoto> photosGetById(OAuthToken authToken, String[] photoIds) throws VkException;
}

...
public class VkGroupBuilder {
    ...
    public VkGroupBuilder addMembersCount(String membersCount) {
        this.membersCount = Long.parseLong(membersCount);
        return this;
    }

    public VkGroupBuilder addVerified(String verified) {
        this.verified = "1".equals(verified);
        return this;
    }
